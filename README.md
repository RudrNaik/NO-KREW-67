...
The new mini radar jamming pods are custom to the ifrit and occupy the front and rear weapon bays. Ground crews also have to swap out the bay panels for custom fit ones so they can sit flush with the jamming pods. They are also coated with radar absorbent materials- meaning you wont be gaining as much to your RCS with the normal pods. Though, with being  'Mini' and also lower power- it also means that they cannot beat radar burnthrough. So within 10-15km of a radar source, the jammer will not be able to blind a target depending on the capacitor's charge.
...
- BepInEx
- [Highly reccomended] NOMM Mod Manager
- [Highly reccomended] Bepinex configuration manager
